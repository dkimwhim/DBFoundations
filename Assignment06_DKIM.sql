...
-- 2020-08-11,DKIM,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_DKIM')
	 Begin 
	  Alter Database [Assignment06DB_DKIM] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_DKIM;
	 End
	Create Database Assignment06DB_DKIM;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_DKIM;
